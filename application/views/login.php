...
$(function(){
	...
	$('#forgot').click(function(){
		alert("Mail Your Details at:- admin@kccemsr.edu.in");
	});
...
<div id="tabs" class="mt-3 mb-4">
	<ul style="padding-bottom:10px;">
		...
		<li style="float:right; background-color:#540000;"><a href="#tabs-3" style="color:white;">ADMIN</a></li>
	</ul>
	<div id="tabs-1">
	...
	<div id="tabs-2">
		<?= form_open('',['id'=>'register_form']) ?>
				...
				<p id="alert">* Fields are Mandatory</p>
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
